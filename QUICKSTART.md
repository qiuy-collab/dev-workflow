...
- Skill 1 must complete 5 core question groups (Q1-Q5), each with `options + custom answer`.
...
- autoMode only controls Skill-to-Skill progression; it does not skip mandatory sub-steps inside a Skill.
